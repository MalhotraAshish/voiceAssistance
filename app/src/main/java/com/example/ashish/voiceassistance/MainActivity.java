package com.example.ashish.voiceassistance;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String PREFS = "ashi";
    private static final String NEW = "new";
    private static final String NAME = "Ashish Malhotra";
    private static final String AGE = "22";
    private static final String AS_NAME = "Ashu";
